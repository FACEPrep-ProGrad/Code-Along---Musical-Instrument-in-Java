...
//Insert instrument details in excel file	
	public void excelgenerator(Instrument instrument, List<Instrument> list) throws Exception {
		...
		try {
			in = new FileInputStream("D:\\Java\\Musical_Store_Excel\\musicalstore\\InstrumentDetails.xlsx");
		    ...
		    out = new FileOutputStream(new File("D:\\Java\\Musical_Store_Excel\\musicalstore\\InstrumentDetails.xlsx"));
	        workbook.write(out);
	        out.close();
...
public void ordergenerator(Order instrument, List<Order> list) throws Exception {
		...
		try {
			in = new FileInputStream("D:\\Java\\Musical_Store_Excel\\musicalstore\\CustomerOrderDetails.xlsx");
			XSSFWorkbook workbook = new XSSFWorkbook(in);
			XSSFSheet sheet = workbook.getSheetAt(0);
			int rowCount = sheet.getLastRowNum();
		    ...
		    out = new FileOutputStream(new File("D:\\Java\\Musical_Store_Excel\\musicalstore\\CustomerOrderDetails.xlsx"));
	        workbook.write(out);
	        out.close();
...
public void customerexcelinsert(User user, List<User> list) throws Exception {
		...
		try {
			in = new FileInputStream("D:\\Java\\Musical_Store_Excel\\musicalstore\\CustomerDetails.xlsx");
			XSSFWorkbook workbook = new XSSFWorkbook(in);
			XSSFSheet sheet = workbook.getSheetAt(0);
			int rowCount = sheet.getLastRowNum();
		    ...
		    out = new FileOutputStream(new File("D:\\Java\\Musical_Store_Excel\\musicalstore\\CustomerDetails.xlsx"));
	        workbook.write(out);
	        out.close();
		...
		try
	      {
	          ...
	          FileInputStream file = new FileInputStream(new File("D:\\Java\\Musical_Store_Excel\\musicalstore\\InstrumentDetails.xlsx"));
	          XSSFWorkbook workbook = new XSSFWorkbook(file);
	          XSSFSheet sheet = workbook.getSheetAt(0);
	          for (int rowIndex = 1; rowIndex <= sheet.getLastRowNum(); rowIndex++) {
	        	  row = sheet.getRow(rowIndex);
...
//Particular customer order details 
	public void userorderdetails(String mobileno) {
		try
	      {
	          FileInputStream file = new FileInputStream(new File("D:\\Java\\Musical_Store_Excel\\musicalstore\\CustomerOrderDetails.xlsx"));
	          XSSFWorkbook workbook = new XSSFWorkbook(file);
	          XSSFSheet sheet = workbook.getSheetAt(0);
	          Iterator<Row> rowIterator = sheet.iterator();
	          int flag=0;
